...
Almong with race, we also discovered some discrepancies with age. We discovered that there was an inconsistent age group among StratificationID1. To observer how this effects the different health conditions, we first wanted to see which age grouped were analyzed and not.
![](../../images/age_prev.png)

From the graph, we realized not every health condition was observed for every age group, nor were the range of age groups consistent. For exam, there would be an age 10-14 age group, as well as a 12-17. Given this information, we focused on analysis of alcohol and tabacco use in high school students. We were able to do this by filtering out "high school students" within Question.
![](../../images/alctab_race.png)
![](../../images/alctab_prev.png)
We were able to visualize the average prevelance of alcohol and tabacco use among high school students within the different race categories, as well as how the prevelance changes over time.
