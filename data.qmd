...
## Where to Find the Data
This dataset was published in united states census bureau. The dataset can be accessed directly from the Small Area Health Insurance Estimates(/https://www.census.gov/programs-surveys/sahie.html)
...
## Key Variables in Our Analysis with Dataset 2
The original dataset with after cleaned there are 37026 obversions with 11 variables. This can help the analysis the insurance cover with in each different state, what different with sex/race/age in the different health topic(relative with the Dataset 1 ), also, how different income level effect the insurance rate.
So we do choice : Age, Income ,Race,Sex,and the Location as the key variable of this dataset.
[Dataset cleaned]: (/dataset/sahie_cleaned.rds)
